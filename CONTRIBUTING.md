...
<h1 align="center">Contributing to Artemis' Thin Logs</h1>

<p align="center">
  Thank you for your interest in contributing to Artemis' Thin Logs.
</p>

<p align="center">
  Contributions help improve the mod and are welcome in many forms, including bug fixes, new wood content, world-generation improvements, compatibility improvements, code improvements, documentation changes, and other useful additions.
</p>
...
<p align="center">
  ...
  &nbsp;&nbsp;&nbsp;
  <a href="https://github.com/IntelligenceModding/ThinLogs/issues/new/choose"><img src="https://img.shields.io/badge/GitHub-Open%20an%20Issue-181717?style=for-the-badge&logo=github&logoColor=white" alt="Open a GitHub Issue"></a>
</p>
...
- [Developing Thin Logs](#developing-thin-logs)
  - [Testing](#testing)
...
Reporting bugs is one of the easiest ways to contribute to Thin Logs.

Before opening an issue:

- check whether the problem has already been reported;
- make sure you are using a Thin Logs version intended for your Minecraft version;
- make sure your mod loader and required dependencies are compatible with the Thin Logs version you are using;
...
Suggestions for new wood variants, building options, world-generation improvements, compatibility improvements, or other features are welcome.

Before creating a feature request:

- check existing issues for similar suggestions;
- explain what the feature would add to Thin Logs;
...
Thin Logs uses separate branches for different Minecraft versions and mod loaders.
...
Before working on Thin Logs, make sure you have the following installed:
...
If you are contributing through a pull request, first fork the [Thin Logs repository][repository] to your own GitHub account.

Clone your fork:

```bash
git clone https://github.com/YOUR_USERNAME/ThinLogs.git
cd ThinLogs
```
...
```bash
git remote add upstream https://github.com/IntelligenceModding/ThinLogs.git
```
...
Thin Logs includes the Gradle wrapper, so installing Gradle separately is normally not necessary.
...
Running the development client is strongly recommended for changes that affect gameplay, blocks, rendering, models, textures, sounds, recipes, world generation, or other in-game behavior.

## Developing Thin Logs

### Testing

Changes should be tested before being submitted.

There is currently no expectation that every contribution includes automated tests. For most Thin Logs changes, practical in-game testing is more useful.
...
For changes affecting thin logs, make sure placement, orientation, stripping, surrounding leaves, carpets, moss carpet, snow layers, snow blocks, and other supported interactions continue to behave correctly where applicable.

For changes affecting naturally generated thin trees or fungi, test the result in newly generated chunks and in the relevant biomes or dimensions.
...
Contributions involving textures, models, sounds, or other assets are welcome where they fit the style and purpose of Thin Logs.
...
- keep thin variants visually consistent with their corresponding vanilla wood types;
...
Documentation changes should be clear, accurate, and relevant to Thin Logs.
...
By submitting code, documentation, textures, models, sounds, or other material to Thin Logs, you confirm that you have the right to contribute that material.

Unless explicitly agreed otherwise, contributions are made under the license used by the Thin Logs repository.
...
[repository]: https://github.com/IntelligenceModding/ThinLogs "Thin Logs GitHub Repository"
[new-issue]: https://github.com/IntelligenceModding/ThinLogs/issues/new/choose "Create a New Issue"
[branches]: https://github.com/IntelligenceModding/ThinLogs/branches "Thin Logs Branches"
